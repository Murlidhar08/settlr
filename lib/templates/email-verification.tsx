      ...
      <tr>
        <td align="center">
            ...
            <tr>
              <td style="padding:0 40px 40px 40px;">
                ...
                <p style="margin:0 0 24px 0; font-size:16px; line-height:24px; color:#475569; text-align:center;">
                  Thanks for signing up! To get started with ${appName}, please verify your email address by clicking the button below.
                </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td align="center" style="padding:10px 0 30px 0;">
                      <a href="${verifyUrl}" style="display:inline-block; padding:14px 32px; background-color:${primaryColor}; color:#ffffff; text-decoration:none; border-radius:12px; font-size:16px; font-weight:600; box-shadow:0 4px 10px rgba(124, 58, 237, 0.25);">
          ...
          <p style="margin:24px 0 0 0; font-size:12px; color:#94a3b8; text-align:center;">
            Manage your notification settings in your account.
          </p>
        </td>
      </tr>
    </table>
