            ...
            <div className="rounded-[2.5rem] bg-rose-50/30 dark:bg-rose-950/10 border border-rose-500/20 shadow-xs p-8 relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <BetterAuthActionButton
                        requireAreYouSure
                        variant="destructive"
                        className="w-full h-14 rounded-2xl font-black uppercase tracking-widest shadow-xl shadow-rose-500/20 hover:shadow-2xl hover:bg-rose-600 hover:text-white transition-all active:scale-[0.98]"
