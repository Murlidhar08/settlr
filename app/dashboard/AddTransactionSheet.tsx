        ...
        >
            ...
            <div className="flex-1 overflow-y-auto px-5 py-4 space-y-6">
                ...
                <div className="flex p-1 rounded-full bg-muted">
                    ...
                    <button className="flex-1 py-2 rounded-full bg-background shadow text-sm font-bold">
                        Party
                    </button>
                </div>
                ...
                <div className="flex flex-col items-center py-2">
                    <div className="flex items-baseline">
                        ...
                        <Input
                            type="number"
                            placeholder="0.00"
                            className="text-6xl text-center font-bold border-none focus-visible:ring-0"
                        />
                    </div>
